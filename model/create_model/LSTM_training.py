...
visualisation.plot_confusion_matrix(y_true=train_output_true,
                                    ...
                                    save=True,
                                    save_dir=IMAGE_DIR,
                                    filename="lstm_train_confusion_matrix.pdf")
...
visualisation.plot_confusion_matrix(y_true=valid_output_true,
                                    ...
                                    save=True,
                                    save_dir=IMAGE_DIR,
                                    filename="lstm_valid_confusion_matrix.pdf")
...
model = LSTM(49, 64, 8, 3)
model.to(device)
model.load_state_dict(torch.load('created_models/LSTM.pt'))
...
visualisation.plot_confusion_matrix(y_true=test_output_true,
                                    ...
                                    save=True,
                                    save_dir=IMAGE_DIR,
                                    filename="lstm_test_confusion_matrix.pdf")
...
visualisation.plot_precision_recall_curve(y_test=y_test,
                                          ...
                                          save=True,
                                          save_dir=IMAGE_DIR,
                                          filename="lstm_prec_recall_curve.pdf")
